    ...
    <div class="col-md-12">
       ...
       <div class="row mb-3">
         <div class="col-md-2">Status Peminjaman</div>
          ...
          <option value="selesai" <?php if($data['status_peminjaman'] == 'selesai') echo 'selected'; ?>>Selesai</option>
           <option value="terlambat" <?php if($data['status_peminjaman'] == 'terlambat') echo 'selected'; ?>>Terlambat</option>
