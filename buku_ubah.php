    ...
    <div class="col-md-12">
       <form method="post">
        ...
        if(isset($_POST['submit'])) {
            ...
            $query = mysqli_query($koneksi, "UPDATE buku set judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', jumlah_buku='$jumlah_buku' where id_buku=$id");
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8"><input type="text" value="<?php echo $data['jumlah_buku']; ?>" class="form-control" name="jumlah_buku"></div>
        </div>
        <div class="row">
